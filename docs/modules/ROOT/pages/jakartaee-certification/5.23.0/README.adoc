...
* xref:jakartaee-certification/5.23.0/tck-results-full-5.23.0.adoc[Payara Server 5.23.0 - Full profile]
* xref:jakartaee-certification/5.23.0/tck-results-web-5.23.0.adoc[Payara Server 5.23.0 - Web profile]
