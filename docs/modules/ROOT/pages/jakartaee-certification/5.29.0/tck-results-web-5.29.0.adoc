...
**Payara Server 5.29.0 Web Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 5.29.0 (Web Profile)]
|===
...
+
https://docs.payara.fish/enterprise/docs/5.29.0/jakartaee-certification/5.29.0/tck-results-web-5.29.0.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 661.924 s - in TestSuite
[INFO] 
[INFO] Results:
[INFO] 
...
```
 [mvn.test] [INFO] Tests run: 1655, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,326.277 s - in TestSuite
 [mvn.test] [INFO] 
...
```
    ...
    [junit] Tests run: 50, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 0.094 sec
```
