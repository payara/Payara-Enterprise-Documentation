...
**Payara Server 5.21.2 Full Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 5.21.2]
|===
...
+
https://docs.payara.fish/enterprise/docs/5.21.0/jakartaee-certification/5.21.2/tck-results-full-5.21.2.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 648.396 s - in TestSuite
[INFO] 
[INFO] Results:
[INFO] 
...
```
 [mvn.test] [INFO] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,675.504 s - in TestSuite
 [mvn.test] [INFO] 
