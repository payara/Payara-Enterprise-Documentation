...
**Payara Server 5.20.0 Full Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 5.20.0]
|===
...
+
https://docs.payara.fish/enterprise/docs/5.20.0/jakartaee-certification/5.20.0/tck-results-full-5.20.0.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 625.026 s - in TestSuite
[INFO] 
[INFO] Results:
[INFO] 
...
```
 [mvn.test] [INFO] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,670.322 s - in TestSuite
 [mvn.test] [INFO] 
...
```
   ...
   [runcts] OUT => [javatest.batch] Number of Tests Passed      = 1731
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 15
   [runcts] OUT => [javatest.batch] Number of Tests with Errors = 0
   [runcts] OUT => [javatest.batch] Completed running 15 tests.
   [runcts] OUT => [javatest.batch] Number of Tests Passed      = 15
   [runcts] OUT => [javatest.batch] Number of Tests Failed      = 0
