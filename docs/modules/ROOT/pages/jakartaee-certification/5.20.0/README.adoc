...
The following distributions of Payara 5.20.0 are certified:

* xref:jakartaee-certification/5.20.0/tck-results-full-5.20.0.adoc[Payara Server 5.20.0 - Full profile]