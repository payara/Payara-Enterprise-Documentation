...
**Payara Server 5.24.0 Web Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 5.24.0 (Web Profile)]
|===
...
+
https://docs.payara.fish/enterprise/docs/5.24.0/jakartaee-certification/5.24.0/tck-results-web-5.24.0.html
...
```
   [INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 721.213 s - in TestSuite
   [INFO] 
   [INFO] Results:
   [INFO] 
...
```
   [mvn.test] [INFO] Tests run: 1655, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,555.199 s - in TestSuite
   [mvn.test] [INFO] 
