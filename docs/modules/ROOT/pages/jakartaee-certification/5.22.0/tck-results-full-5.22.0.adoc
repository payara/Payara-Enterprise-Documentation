...
**Payara Server 5.22.0 Full Profile Certification Summary**
...
{empty} +
{empty} +
https://www.payara.fish/page/payara-enterprise-downloads/[Payara Server 5.22.0]
|===
...
+
https://docs.payara.fish/enterprise/docs/5.22.0/jakartaee-certification/5.22.0/tck-results-full-5.22.0.html
...
```
[INFO] Tests run: 1043, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 698.994 s - in TestSuite
[INFO] 
[INFO] Results:
[INFO] 
...
```
 [mvn.test] [INFO] Tests run: 1805, Failures: 0, Errors: 0, Skipped: 0, Time elapsed: 1,945.426 s - in TestSuite
 [mvn.test] [INFO] 
