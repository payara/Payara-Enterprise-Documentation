...
The following distributions of Payara 5.22.0 are certified:

* xref:jakartaee-certification/5.22.0/tck-results-full-5.22.0.adoc[Payara Server 5.22.0 - Full profile]
