...
Information about the output made by Payara Micro Enterprise after its booting has completed.

[[deployed-apps]]
== Deployed Apps

After Payara Micro Enterprise has booted, the log output will list data about the instance and its deployed apps.
