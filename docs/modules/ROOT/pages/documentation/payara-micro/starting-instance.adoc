...
This section details the very basics of starting a Payara Micro Enterprise instance.
...
This single command is all you need to run Payara Micro Enterprise instances; additional
