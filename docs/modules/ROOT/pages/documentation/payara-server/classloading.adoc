...
The default class loading mechanism of Payara Server Enterprise works like this:
...
example, Payara Server Enterprise includes the Jackson library, and you might need
...
included on Payara Server Enterprise that belong to *whitelisted packages* defined on its
...
This is because these packages are required by Payara Server Enterprise and therefore
