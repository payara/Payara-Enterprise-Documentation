...
When deploying an EJB-JAR module on Payara Server Enterprise, the portable JNDI names for all scanned EJBs will be generated using the name of the module as specified on the _ejb-jar.xml_ deployment descriptor:
