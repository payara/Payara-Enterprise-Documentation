...
|`--status` | ALL/COMPLETED| The status of batch jobs executions to which delete the records of.
...
|`--days` | Integer| The number of days previous that the end time of the job execution must be to deleted. | 0 | No
|=======================================================================
